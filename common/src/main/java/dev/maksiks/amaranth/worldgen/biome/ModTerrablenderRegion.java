...
import static dev.maksiks.amaranth.worldgen.biome.ModRegionUtils.forEachBiome;
import static dev.maksiks.amaranth.worldgen.biome.ModRegionUtils.sanitize;
...
public class ModTerrablenderRegion extends Region {
    ...
    public ModTerrablenderRegion(int regionId, int overworldWeight,
        ...
        super(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "region_" + count++), RegionType.OVERWORLD, overworldWeight);
