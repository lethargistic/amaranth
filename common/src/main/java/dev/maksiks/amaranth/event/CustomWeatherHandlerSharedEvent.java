...
import static dev.maksiks.amaranth.ClientConfig.SNOW_DIRECTION_CHANGE_TIME_ADDED_RANGE;
import static dev.maksiks.amaranth.ClientConfig.SNOW_DIRECTION_CHANGE_TIME_MIN;
import static dev.maksiks.amaranth.event.ModEventUtils.isPlayerUnderground;

public class CustomWeatherHandlerSharedEvent {
