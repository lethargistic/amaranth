...
public class ModNoises {
    public static final ResourceKey<NormalNoise.NoiseParameters> SILVER_NOISE =
            ResourceKey.create(
                    Registries.NOISE,
                    ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "silver")
            );

    public static final ResourceKey<NormalNoise.NoiseParameters> STRIPE_ATTEMPT_NOISE =
            ResourceKey.create(
                    Registries.NOISE,
                    ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "stripe_attempt")
            );

    public static final ResourceKey<NormalNoise.NoiseParameters> VEINY_NOISE =
            ResourceKey.create(
                    Registries.NOISE,
                    ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "veiny")
            );
    
    public static final ResourceKey<NormalNoise.NoiseParameters> CRACKED_VEINY_NOISE =
            ResourceKey.create(
                    Registries.NOISE,
                    ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "cracked_veiny")
            );

    public static final ResourceKey<NormalNoise.NoiseParameters> PATCHY_NOISE =
            ResourceKey.create(
                    Registries.NOISE,
                    ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "patchy")
            );
