...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(RecipeOutput recipeOutput) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.EMPTY_TEA_CUP.get(), 1)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "empty_tea_cup_from_marble"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.EMPTY_TEA_CUP.get(), 1)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "empty_tea_cup_from_polished_diorite"));
